                    ...
                    () => (
                        <div className="sectionHeader">
                            <div className="sectionHeader__col--left">
                                <h1 className="sectionHeader__title">Obsługa, wszystkie projekty</h1>
                            </div>
                            <div className="sectionHeader__col--right">
                                <strong onClick={addServiceHandler} className="mainPart__navi-button">
                        ...
                        <div className="addModal">
                            <div className="addModal__popup">
                                <div className="addModal__header">
                                    <h2 className="addModal__h2">Dodaj obsługę</h2>
                                </div>
                                        ...
                                        <div className="addModal__form-list">
                                            ...
                                            <div className="addModal__form-item">
                                                <div className="addModal__buttons">
                                                    <button className="addModal__button" name="confirmSave" onClick={saveServiceHandler}>Zapisz</button>
                                                    <button className="addModal__button" name="cancelSave" onClick={saveServiceHandler}>Anuluj</button>
