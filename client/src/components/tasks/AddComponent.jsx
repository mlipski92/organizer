                    ...
                    () => (
                        <div className="sectionHeader">
                            <div className="sectionHeader__col--left">
                                <h1 className="sectionHeader__title"><strong>{currentProjectName}</strong>, wszystkie zadania</h1>
                            </div>
                            <div className="sectionHeader__col--right">
                                <strong onClick={addTaskHandler} className="mainPart__navi-button">
    ...
    const saveTaskHandler = async e => {
        ...
        if (name === "cancelSave") {
            ...
            if (addingTask.title !== null && addingTask.title !== '') {
                await axios.post('http://netcentrum.pl/api/tasks/add', {
                    id: null,
                ...
                .then( response => {
                    ...
                    axios.post('http://netcentrum.pl/api/tasks/getlast')
                    .then(responseLast => {
